...
if ($page == 'home') {
  $rater = isset($_GET['rate']) ? $_GET['rate'] : 0;
  if ($rater) {
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 mr-auto text-center">
            ...
            <a style="text-decoration:none;" class="d-block text-white " href="mailto:<?php echo $_SESSION['system']['email'] ?>"><?php echo $_SESSION['system']['email'] ?></a>
          </div>
        </div>
      </div>
      <br>
